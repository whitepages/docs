...
| _(no `age`)_                                 | `age: integer \| null`                                                                           | New on both Search and Details. Computed from `date_of_birth`; year-only DOB returns a year-based approximation, missing or unparseable DOB returns `null`.                                   |
